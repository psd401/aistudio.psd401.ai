...
export class ObservabilityDashboards extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ObservabilityDashboardsProps) {
    ...
    // Create service-level dashboard
    this.serviceDashboard = this.createServiceDashboard(environment);

    // Create executive dashboard
    this.executiveDashboard = this.createExecutiveDashboard(environment);
